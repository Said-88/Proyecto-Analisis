...
export const queries = {
    ...
    updateEventosById:"UPDATE Usuarios SET nombre_evento=(@nombre) , fecha_evento=(@fecha),lugar_Evento=(@lugar), tipo_evento=(@tipo), descripcion_evento=(@descrip), imagen_evento=(@image), puntos_coprogramaticos=(@puntos) WHERE id=@id",
